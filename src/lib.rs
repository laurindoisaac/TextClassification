// src/lib.rs
/*
 * Core library for TextClassification
 */
...
#[derive(Debug)]
pub struct TextClassificationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TextClassificationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TextClassification processing");
    
    let mut processor = TextClassificationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TextClassificationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TextClassificationProcessor::new(false);
